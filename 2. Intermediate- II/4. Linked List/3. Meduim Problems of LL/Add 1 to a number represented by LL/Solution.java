...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Add one to Linked List");

        Node newLL = adddOneToLinkedList(inputList); 
    ...
    // addOne to Linked List

    private static Node  adddOneToLinkedList(Node head)
    {
